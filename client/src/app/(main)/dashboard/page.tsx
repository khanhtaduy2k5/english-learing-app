...
export default function DashboardPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
      {/* Welcome Banner */}
      <div className="relative p-6 md:p-8 rounded-3xl overflow-hidden bg-gradient-to-r from-indigo-100 via-violet-100 to-background dark:from-indigo-900/30 dark:via-purple-900/20 dark:to-background border border-border shadow-2xl backdrop-blur-sm">
        <div className="absolute top-0 right-0 w-80 h-80 bg-indigo-500/15 dark:bg-indigo-500/10 rounded-full blur-3xl -z-10"></div>
        <div className="absolute bottom-0 right-20 w-60 h-60 bg-purple-500/15 dark:bg-purple-500/10 rounded-full blur-3xl -z-10"></div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {[
          ...
          },
          {
            ...
            border: "hover:border-orange-500/20 animate-pulse",
          },
          {
            label: "XP Points",
            value: 0,
          ...
          >
            <CardBody className="p-1 mb-0">
              <div className="flex items-center justify-between mb-3">
                <span className="text-2xl bg-foreground/5 w-10 h-10 rounded-xl flex items-center justify-center shadow-inner">
                  {stat.icon}
                </span>
              </div>
              <p
      ...
      <div>
        ...
        <div className="relative p-6 rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-background border border-border shadow-xl backdrop-blur-md flex flex-col justify-between min-h-[180px] group transition-all duration-300 hover:shadow-indigo-500/5 hover:border-indigo-500/20 w-full">
          <div className="absolute -top-10 -left-6 text-9xl text-indigo-500/10 font-serif select-none pointer-events-none group-hover:scale-110 transition-transform duration-500">
            “
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            },
            {
              ...
              glow: "hover:border-purple-500/20",
            },
            {
              label: "Vocabulary",
              href: "/vocabulary",
            ...
            <Link key={action.label} href={action.href} className="block group">
              ...
              >
                <CardBody className="mb-0 p-1 flex flex-col h-full">
                  <span className="text-3xl mb-3 block group-hover:scale-110 group-hover:-translate-y-0.5 transition-all duration-300">
                    {action.icon}
                  </span>
